...
func doNetstat(paths []string, fn AcceptFn) ([]SockTabEntry, error) {
	alltabs := []SockTabEntry{}
...
func osSocks(accept AcceptFn) ([]SockTabEntry, error) {
	return doNetstat([]string{pathTCPTab, pathTCP6Tab, pathUDPTab, pathUDP6Tab}, accept)
}
